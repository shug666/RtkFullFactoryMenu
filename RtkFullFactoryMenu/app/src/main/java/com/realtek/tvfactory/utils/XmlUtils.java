...
public class XmlUtils {
    ...
    public static final Bundle readThisBundleXml(XmlPullParser parser, String endTag,
            String[] name) throws XmlPullParserException, java.io.IOException {
        return readThisBundleXml(parser, endTag, name, null);
    }
        ...
        do {
            if (eventType == XmlResourceParser.START_TAG) {
                ...
                if (int.class.equals(clazz) || Integer.class.equals(clazz)) {
                	bundle.putInt(name[0], (Integer) val);
                } else if (long.class.equals(clazz) || Long.class.equals(clazz)) {
                	bundle.putLong(name[0], (Long) val);
                } else if (float.class.equals(clazz) || Float.class.equals(clazz)) {
                	bundle.putFloat(name[0], (Float) val);
                } else if (double.class.equals(clazz) || Double.class.equals(clazz)) {
                	bundle.putDouble(name[0], (Double) val);
                } else if (boolean.class.equals(clazz) || Boolean.class.equals(clazz)) {
                	bundle.putBoolean(name[0], (Boolean) val);
                } else if (String.class.equals(clazz)) {
                	bundle.putString(name[0], (String) val);
                } else if (int[].class.equals(clazz)) {
                	bundle.putIntArray(name[0], (int[]) val);
                } else if (long[].class.equals(clazz)) {
                	bundle.putLongArray(name[0], (long[]) val);
                } else if (double[].class.equals(clazz)) {
                	bundle.putDoubleArray(name[0], (double[]) val);
                } else if (boolean[].class.equals(clazz)) {
                	bundle.putBooleanArray(name[0], (boolean[]) val);
                } else if (String[].class.equals(clazz)) {
                	bundle.putStringArray(name[0], (String[]) val);
                }
            } else if (eventType == XmlResourceParser.END_TAG) {
                if (parser.getName().equals(endTag)) {
                    return bundle;
