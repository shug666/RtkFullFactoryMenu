...
public class VolumeCurveLogic extends LogicInterface {
    ...
    private void getAndLoadData(){
        ...
        mFactoryMainApi.setStringValue(TvCommonManager.USER_VOLUME_SOURCE, mSource.getCurrentEntryName());
    ...
    static class MyHandler extends Handler {
        ...
        private final WeakReference<VolumeCurveLogic> reference;
        private final FactoryMainApi mFactoryMainApi;
            ...
            switch (msg.what) {
                case 0: {
                    ...
                    if (entryValue instanceof TvInputInfo) {
                        ...
                        String input = inputSource.loadLabel(logic.mContext).toString();
